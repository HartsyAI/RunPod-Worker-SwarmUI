...
MODEL_SPECS: Dict[str, ModelSpec] = {
    "flux-dev": ModelSpec(
        ...
        destination=Path("Models/Stable-Diffusion/BFL/flux1-dev-fp8.safetensors"),
        requires_token=True,
    ...
    "flux-schnell": ModelSpec(
        ...
        destination=Path("Models/Stable-Diffusion/BFL/flux1-schnell-fp8.safetensors"),
        requires_token=True,
    ...
    "sdxl-base": ModelSpec(
        ...
        destination=Path("Models/Stable-Diffusion/StabilityAI/sdxl-base-1.0.safetensors"),
    ),
    "flux-dev-gguf": ModelSpec(
        ...
        destination=Path("Models/diffusion_models/BFL/flux1-dev-Q4_K_S.gguf"),
        requires_token=True,
        notes="Quantized GGUF checkpoint for low-VRAM inference",
    ),
    "sd3.5-fp8-large": ModelSpec(
        key="sd3.5-fp8-large",
        name="SD3.5 Large FP8",
        ...
        destination=Path("Models/Stable-Diffusion/StabilityAI/sd3.5-large-fp8.safetensors"),
        requires_token=True,
